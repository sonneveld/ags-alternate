...
#else /* INCLUDE_MANAGED_CODE */

void ThrowManagedException(const char *message) 
{
	// need to setup some sort of callback for above managed code.
	throw new AGSEditorException(message);
}
